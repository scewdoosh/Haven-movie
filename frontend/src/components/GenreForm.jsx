  ...
  return (
    <div className="p-3">
      <form onSubmit={handleSubmit} className="space-y-3">
        ...
        <div className="flex">
          <button className="bg-teal-500 text-white py-2 px-4 rounded-lg hover:bg-teal-600 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-opacity-50 mr-3.5">
            {buttonText}
          </button>
